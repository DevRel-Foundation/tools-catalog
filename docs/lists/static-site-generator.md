...
Nextra is a static site generator for building documentation websites using React and Next.js. It supports Markdown and provides a simple way to create and maintain documentation sites with a focus on performance and ease of use. ([Data](../../data/nextra.site.json))
